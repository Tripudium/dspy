...
class FeatureMethods:
    ...
    def add_mid(
        self, products: list[str] | None = None, cols: list[str] = ["prc_s0", "prc_s1"]
    ) -> pl.DataFrame:
        """
    ...
    def add_volume(
        self, products: list[str] | None = None, cols: list[str] = ["vol_s0", "vol_s1"]
    ) -> pl.DataFrame:
        """
    ...
    def add_rel_returns(
        self, products: list[str] | None = None, cols: list[str] = ["mid"]
    ) -> pl.DataFrame:
        """
