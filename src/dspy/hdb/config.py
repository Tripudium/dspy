...
Example:
    ...
    >>> from dspy.hdb.config import TARDIS_API_KEY, TARDIS_DATA_PATH
    >>> if TARDIS_API_KEY:
...
See Also:
    dspy.hdb.tardis_dataloader: Uses TARDIS_API_KEY for data access
    dspy.hdb.base: Uses common data path constants
"""
